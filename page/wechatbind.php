...
<? createHeader('微信绑定'); ?>
		<div id="frame1" class="frame">
			<div class="groups">
				...
				<? if ($errormsg == '') : ?>
					<div>
						<img id="wechat_qrcode" src="http://my.nuaa.edu.cn/mytools/?tool=qrcode&text=wechatbind://<?=rawurlencode($logincode)?>" alt="扫码登录" style="width:200px;height:200px;border:2px solid;border-radius:0.5em;margin-bottom:0.5em">
